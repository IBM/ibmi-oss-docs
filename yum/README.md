# Table of Contents
- [RPM pile for IBM i releases in standard support](#rpm-pile-for-ibm-i-releases-in-standard-support)
  * [General Information](#general-information)
    + [Notable deliverables](#notable-deliverables)
  * [Installation](#installation)
    + [Installing with Access Client Solutions (ACS)](#installing-with-access-client-solutions--acs-)
    + [Online Install Instructions (without ACS Open Source Management Tool)](#online-install-instructions--without-acs-open-source-management-tool-)
    + [Offline Install Instructions (without ACS)](#offline-install-instructions--without-acs-)
  * [Switching from FTP to HTTP(S)](#switching-from-ftp-to-http-s-)
  * [Using yum on an IBM i system without internet access](#using-yum-on-an-ibm-i-system-without-internet-access)
    + [1. Use a proxy](#1-use-a-proxy)
    + [2. Create a local repository mirror](#2-create-a-local-repository-mirror)
  * [Must-know Usage Notes!!! (READ THIS AFTER YOU INSTALL)](#must-know-usage-notes-----read-this-after-you-install-)
    + [Fully Qualifying](#fully-qualifying)
    + [Adjusting your PATH](#adjusting-your-path)
  * [Installing additional software](#installing-additional-software)
    + [Using Access Client Solutions (ACS)](#using-access-client-solutions--acs-)
    + [Yum cheat sheet](#yum-cheat-sheet)
    + [Common commands](#common-commands)
    + [Installing Python 3 and some useful Python packages](#installing-python-3-and-some-useful-python-packages)
    + [Installing Python 3 Machine Learning packages](#installing-python-3-machine-learning-packages)
    + [Installing Node.js](#installing-nodejs)
    + [Installing GCC and development tools](#installing-gcc-and-development-tools)
    + [Using a chroot](#using-a-chroot)
  * [Troubleshooting](#troubleshooting)
  * [FAQ](#faq)
    + [What if I run in to issues?](#what-if-i-run-in-to-issues-)
    + [How do I get support for open source on IBM i?](#how-do-i-get-support-for-open-source-on-ibm-i-)
    + [Is 5733-OPS required in order to install the RPM-based deliverables?](#is-5733-ops-required-in-order-to-install-the-rpm-based-deliverables-)
    + [When will tools and language runtimes be 64-bit enabled?](#when-will-tools-and-language-runtimes-be-64-bit-enabled-)
    + [Will 5733-OPS be updated to ship Node.js version 8, Python 3.6, or other goodies that are currently in RPM form only?](#will-5733-ops-be-updated-to-ship-nodejs-version-8--python-36--or-other-goodies-that-are-currently-in-rpm-form-only-)
    + [Is this the same thing as Perzl.org or other RPM's I have heard of (or used) in the past?](#is-this-the-same-thing-as-perzlorg-or-other-rpm-s-i-have-heard-of--or-used--in-the-past-)
    + [What if I am on an IBM i release no longer in standard support?](#what-if-i-am-on-an-ibm-i-release-no-longer-in-standard-support-)
    + [Third-party (non-IBM) repositories](#third-party--non-ibm--repositories)
